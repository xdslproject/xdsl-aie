...
"builtin.module"() ({
  "aie.device"() <{device = 4 : i32, sym_name = "main"}> ({
    ...
    ^bb0(%arg0 : memref<8xi16>, %arg1 : memref<10xi32>):
      %2 = "aiex.dma_configure_task"(%0) <{channel = 0 : i32, direction = 1 : i32, issue_token = true}> ({
        "aie.dma_bd"(%arg0) <{bd_id = 7 : i32, static_len = 8 : i32, static_offset = 0 : i32, operandSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0>}> : (memref<8xi16>) -> ()
        "aie.end"() : () -> ()
      }) : (index) -> index
      %3 = "aiex.dma_configure_task"(%1) <{channel = 1 : i32, direction = 0 : i32, issue_token = true, repeat_count = 2 : i32}> ({
        "aie.dma_bd"(%arg1) <{bd_id = 8 : i32, static_len = 10 : i32, static_offset = 0 : i32, operandSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0>}> : (memref<10xi32>) -> ()
        "aie.end"() : () -> ()
      }) : (index) -> index
  ...
  "aie.device"() <{device = 4 : i32, sym_name = "main"}> ({
    ...
    ^bb0(%arg0: memref<8xi16>, %arg1: memref<10xi32>):
      %2 = "aiex.dma_configure_task"(%0) <{channel = 0 : i32, direction = 1 : i32}> ({
        "aie.dma_bd"(%arg0) <{bd_id = 0 : i32, static_len = 8 : i32, static_offset = 0 : i32, operandSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0>}> : (memref<8xi16>) -> ()
        "aie.next_bd"()[^bb1] : () -> ()
      ^bb1:  // pred: ^bb0
        "aie.dma_bd"(%arg1) <{bd_id = 1 : i32, static_len = 10 : i32, static_offset = 2 : i32, operandSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0>}> : (memref<10xi32>) -> ()
        "aie.next_bd"()[^bb2] : () -> ()
      ^bb2:  // pred: ^bb1
        "aie.dma_bd"(%arg0) <{bd_id = 2 : i32, static_len = 10 : i32, static_offset = 2 : i32, operandSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0>}> : (memref<8xi16>) -> ()
        "aie.end"() : () -> ()
      }) : (index) -> index
    }) : () -> ()
    "aie.end"() : () -> ()
